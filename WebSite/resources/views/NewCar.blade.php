...
<html lang="en">
    ...
    <body>
        ...
        <form action="{{route('newCar.store')}}" method="post">
            ...
            <input type="number" name="Horsepower" id="Horsepower" placeholder="Horsepower" value="">
            ...
            <input type="number" name="Engine" id="Engine" placeholder="Engine" value="">
            <label for="No_Doors">No_Doors</label>
            <input type="number" name="No_Doors" id="No_Doors" placeholder="No_Doors" value="">
            <label for="Year">Year</label>
            <input type="number" name="Year" id="Year" placeholder="Year" value="">
